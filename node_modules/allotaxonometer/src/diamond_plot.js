...
import { max, shuffle, range } from "d3";
import { scaleLog, scaleLinear, scaleBand, scaleSequentialLog } from "d3";
...
const visHeight = 412  //changed
const visWidth = 412  //changed

export default function DiamondChart(dat, passed_svg) {

    const margin = ({ top: 200, left: 40, right: 140, bottom: 140 })
    ...
    return g.node();
    // return passed_svg.node().appendChild(svg.node());
}
