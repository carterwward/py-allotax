...
async function createAllotaxChart(data_1, data_2, alpha, title1, title2, passed_svg) {
    ...
    // Plot
    DiamondChart(diamond_dat, alpha, title1, title2, maxlog10, rtd.normalization, passed_svg.diamond_svg);
